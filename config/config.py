...
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://e27sow7ith:<password>@izzyyir.6b7owbg.mongodb.net/?retryWrites=true&w=majority")
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6021591808 6041018391").split())
